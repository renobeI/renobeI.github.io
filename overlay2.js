...
// @tag canvas
// @noframes
// @updateURL https://renobei.github.io/overlay2.js
// @downloadURL https://renobei.github.io/overlay2.user.js
// ==/UserScript==
...
async function getBlobFromURL(url) {
    ...
    if (response.status !== 200) {
        ...
        if (url !== `${DATA_DOMAIN}/overlay/global.png`) {
            setupOverlay(`${DATA_DOMAIN}/overlay/global.png`);
        }
